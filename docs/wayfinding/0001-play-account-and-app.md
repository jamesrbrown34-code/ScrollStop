---
title: Create the Play developer account and app shell
type: task
status: open
blocked-by: []
---
...
Create the Google Play developer account ($25) and the app shell in Play Console, so everything after it has somewhere to live.
...
Resolved when the app shell exists and the account details are recorded in a resolution comment.
